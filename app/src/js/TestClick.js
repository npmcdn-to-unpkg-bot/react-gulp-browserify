...
var TestClickComponent = React.createClass({
    ...
    render() {
        return (
            React.createElement("div", null, React.createElement("button", {type: "button", className: "btn btn-default", onClick: this.handleClick}, "显示|隐藏"), React.createElement("span", {ref: "tip"}, "测试点击"))
        );
    },
    handleClick(e){
    	alert('clicked')
...
var TestInputComponent = React.createClass({
    ...
    render() {
        return (
            React.createElement("div", null, React.createElement("input", {type: "text", value: this.state.inputContent, onInput: this.changeHandler}), React.createElement("br", null), React.createElement("br", null), React.createElement("br", null), React.createElement("span", {ref: "showBox"}, this.state.inputContent))
        );
    },
    getInitialState() {
        return {
