...
var Demo = React.createClass({displayName: "Demo",
    ...
    render: function () {
        ...
        return (React.createElement("div", {className: "wiget-select-container", value: this.state.selectedValue, onClick: this.handleClick2}, 
                            React.createElement("span", null, this.state.selectedName), 
                            React.createElement("ul", {style: this.state.style}, opts)
                    ))
    },
